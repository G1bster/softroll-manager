...
-- Розбито на 2 повідомлення: одним рядком все речення виходило 278 байт
-- UTF-8 — понад ліміт SendChatMessage (255 байт), через що клієнт мовчки
-- обрізав кінець фрази ("не вміщається").
L.WHISPER_HELP                  = "Довідка: sr [лінк] (або sr [лінк] x2) — зареєструвати софт-рол / sr list — переглянути ваші софти"
L.WHISPER_HELP_2                = "sr clear [лінк] — видалити предмет / sr clear — очистити всі"
